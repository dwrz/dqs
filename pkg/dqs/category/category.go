...
import (
	...
	"github.com/dwrz/dqs/pkg/dqs/portion"
)
...
func (c *Category) AddPortions(q float64) error {
...
func (c *Category) CalculateScore() (total float64) {
...
func (c *Category) RemovePortions(q float64) error {
